...
import (
	"context"
	"github.com/l1nkkk/shopSystem/demo/product/backend/web/controllers"
...
func main() {
	...
	// Layout指定布局文件
	tmplate := iris.HTML("./demo/product/backend/web/views", ".html").Layout("shared/layout.html").Reload(true)
	app.RegisterView(tmplate)

	// 4-1.设置模板静态资源目录
	//app.StaticWeb("/assets", "./backend/web/assets") // 旧方法，已经弃用
	app.HandleDir("/assets", "./demo/product/backend/web/assets")
	// 4-2.指定异常跳转页面
