...
func main() {
	...
	// 3.注册模板
	tmplate := iris.HTML("./demo/productOptim/fronted/web/views", ".html").
		Layout("shared/layout.html").Reload(true)
	app.RegisterView(tmplate)
	// 4.设置静态资源资源。127.0.0.1:8082/public
	//app.StaticWeb("/public", "./fronted/web/public")
	app.HandleDir("/public", "./demo/productOptim/fronted/web/public")

	// l1nkkk: 静态化优化
	// 访问生成好的html静态文件。127.0.0.1:8082/html
	//app.StaticWeb("/html", "./fronted/web/htmlProductShow")
	app.HandleDir("/html", "./demo/productOptim/fronted/web/htmlProductShow")
